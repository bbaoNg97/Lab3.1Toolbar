...
private TextView textViewMessage;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            //todo:increse font size
            if (size < max) {
                size++;
                textViewMessage.setTextSize(size);
            } else {//getApplicationContext()=this
                //Toast is something like a msg,but it will disaapear according toast.length
                //have to put .show() else it will not dislay
